...
function gotData(data) {
  ...
  for(var i=0;i<keys.length;i++)
  {
			...
			var Ten_cm=scores[k].tencm_reading;
			var Twenty_cm=scores[k].twentycm_reading;
			var Thirty_cm=scores[k].thirtycm_reading;
			var Forty_cm=scores[k].fortycm_reading;
			...
			array.push(wrist,Ten_cm,Twenty_cm,Thirty_cm,Forty_cm);
			/*array.push(twentycm);
			array.push(thirtycm);
			array.push(fortycm);
			array.push(wrist);
